...
export const unCommentLine = (line, isInSlashStar) => {
  ...
  if (isInSlashStar) {
    ...
    const slashSlashDetected = posSlashSlash >= 0
    const noSlashStarBeforeSlashSlash = posSlashStar < 0 ||
      posSlashStar > posSlashSlash
    if (slashSlashDetected && noSlashStarBeforeSlashSlash) {
